       ...
       <table id="example" class="display" style="width:100%">
        ...
        <%
            ...
            for(Driver driver:driverList){
                ...
                out.print("<td>"+driver.getCity()+"</td>");
                out.print("<td>"+driver.getGender()+"</td>");
                out.print("<td>"+driver.getEmail()+"</td>");
                out.print("<td>"+driver.getPhone()+"</td>");
                out.print("<td>"+driver.getAge()+"</td>");
